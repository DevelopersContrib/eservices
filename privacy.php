...
<title>Privacy <?=$domain?></title>
	<meta name="title" content="Privacy <?=$domain?> " />
	<meta name="description" content="Privacy <?=$domain?> today." />
    </head>
<body>
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Privacy <?=$domain?></h1>
                        <!-- end page title -->
                    </div>
            ...
            <div class="container">
				<div class="row">
                    <div class="col-md-5 col-sm-8 text-center center-col">
                        <p class="title-large text-uppercase letter-spacing-1 black-text font-weight-600"><?=$domain?> Privacy Policy</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="box-blck">
                        <h2 class="ttle text-capitalize">
                            <?php echo $domain?> Privacy Policy
                        </h2>
                        <p class="text-justify">
                            This privacy policy sets out how <?php echo $domain?> uses and protects any information that you give <?php echo $domain?> when you use this website. <?php echo $domain?> is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement. <?php echo $domain?> may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 18th of January, 2012.
                        </p>
                        <br />
                        <h2 class="ttle text-capitalize">
                            What we collect
                        ...
                        <ul class="list-unstyled text-left">
                            <li>
                                <i class="fa fa-check"></i> name and job title
                            </li>
                            <li>
