        ...
        <div class="row">
          ...
          <div class="navbar-collapse collapse">         
            <form class="navbar-form navbar-left search" action="<?php echo Main::ahref("","search") ?>">
              <input type="text" class="form-control" size="80" placeholder="Search for users, polls or payments and press enter" name="q">
      ...
      <div class="row">
        <div class="col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo $this->url ?>/"><span class="glyphicon glyphicon-home"></span> Dashboard</a></li>
            <li><a href="<?php echo Main::ahref("polls") ?>"><span class="glyphicon glyphicon-th-list"></span> Polls</a></li>
