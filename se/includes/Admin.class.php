...
class Admin{
  ...
  protected function polls(){
    ...
    $header="Polls ({$this->db->rowCount}) <a href='".Main::href("create")."' class='btn btn-xs btn-primary pull-right'>Create</a>";
    $thead="<th><input type='checkbox' id='check-all'></th><th><a href='".Main::ahref("polls&filter=id","polls?filter=id")."'><span class='glyphicon glyphicon-sort pull-right'></span> Poll ID</a></th><th>User ID</th><th>Question</th><th>Number of Answers</th><th><a href='".Main::ahref("polls&filter=votes","polls?filter=votes")."'><span class='glyphicon glyphicon-sort pull-right'></span> Votes</a></th><th>Open</th><th>Options</th>";
    $tbody="";
      foreach ($polls as $poll){
              $tbody.="<tr>
                ...
                <td>
                  ...
                  <a href='".Main::ahref("polls/delete/{$poll->id}&".Main::nonce(),"polls/delete/{$poll->id}?".Main::nonce())."' class='btn btn-xs btn-danger delete'>Delete</a>
                </td>
              </tr>";             
      }
            ...
            <form action='".Main::ahref("polls/edit/{$poll->id}")."' method='post'>                  
              <div class='col-md-8'>
                <div class='box-holder live_form'>                  
				  ...
				  <h4>".e('Image Url')."</h4>
                  <div class='form-group'>
                    <input type='text' class='form-control' placeholder='Optional e.g. http://example.com/example.png' name='image_url' value='{$poll->image_url}'>
                  </div> 	
                  <h4>".e('Answers')."</h4>
                    <ul id='sortable'>";
  ...
  protected function users(){
    ...
    $header="Users ({$this->db->rowCount}) <a href='".Main::ahref("users/add")."' class='btn btn-xs btn-primary pull-right'>Add User</a>";
    $thead="<th><input type='checkbox' id='check-all'></th><th><a href='".Main::ahref("users&filter=id","users?filter=id")."'><span class='glyphicon glyphicon-sort pull-right'></span>  User ID</a></th><th>Email</th><th><a href='".Main::ahref("users&filter=date","users?filter=date")."'><span class='glyphicon glyphicon-sort pull-right'></span>  Registration Date</a></th><th><a href='".Main::ahref("users&filter=mem","users?filter=mem")."'><span class='glyphicon glyphicon-sort pull-right'></span>  Membership</a></th><th><a href='".Main::ahref("users&filter=expire","users?filter=expire")."'><span class='glyphicon glyphicon-sort pull-right'></span>  Membership Expiration</a></th><th>Options</th>";
    $tbody="";
        ...
        if($this->config["demo"]) $user->email="Hidden in demo to protect privacy";
              $tbody.="<tr>
                ...
                <td>
                  ...
                  <a href='".Main::ahref("users/delete/{$user->id}&".Main::nonce(),"users/delete/{$user->id}?".Main::nonce())."' class='btn btn-xs btn-danger delete'>Delete</a>
                </td>
              </tr>";             
      }
