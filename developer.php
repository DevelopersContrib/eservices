...
<title>Developers <?=$domain?></title>
	<meta name="title" content="Developers -<?=$domain?> " />
	<meta name="description" content="Developers <?=$domain?> today." />
    </head>
<body>
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Developer <?=$domain?></h1>
                        <!-- end page title -->
                    </div>
            ...
            <div class="container">
				<div class="row">
                    <div class="col-md-5 col-sm-8 text-center center-col">
                        <p class="title-large text-uppercase letter-spacing-1 black-text font-weight-600"><?=$domain?> Developers</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5 col-sm-8 col-xs-11 center-col xs-no-padding">
						<div class="blur-box text-justify">
							...
							<div class="form-group text-center">
								<a href="contactus.php" class="btn btn-primary">Inquire Here</a>
							</div>
						</div>
					</div>
				</div>
