...
<title>Referral <?=$domain?></title>
	<meta name="title" content="Referral <?=$domain?> " />
	<meta name="description" content="Referral Survey Ventures today and help us create a rehab center fit for our Veterans." />	
	<style>
	.span12 h1 {
 ...
 <? include 'navigation.php'; ?>   
      <section class="content-top-margin page-title page-title-small bg-gray">
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Referral <?=$domain?></h1>
                        <!-- end page title -->
                    </div>
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-11 center-col xs-no-padding">
						<div class="arrw-rela"><div class="arrw-point-white"></div></div>
                    <br />
                    <iframe width="760px" height="800px" frameborder="0" seamless="" scrolling="auto" src="http://referrals.contrib.com/aff_index.php?affiliate=<?php echo $domain?>"></iframe>
                    <div class="blck2-box">
