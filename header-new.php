...
<body>
  ...
  <!-- navigation --> 
        <nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-border-bottom bg-white" role="navigation">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6"><a class="logo-light" href="index.html"><img alt="Survey Ventures" src="http://d2qcctj8epnr7y.cloudfront.net/images/2013/logo-surveyventures1.png" class="logo" /></a>
					<a class="logo-dark" href="#">
					<img alt="Survey Ventures" src="http://d2qcctj8epnr7y.cloudfront.net/images/2013/logo-surveyventures1.png" class="logo" /></a></div>
